...
REM provide your .sln file as an argument
...
dotnet sln %1 add Walnut.Api/Walnut.Api.csproj
dotnet sln %1 add Walnut.Data/Walnut.Data.csproj
dotnet sln %1 add Walnut.Models/Walnut.Models.csproj
